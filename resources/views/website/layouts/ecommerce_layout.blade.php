...
<head>
    ...
    <!-- include the site stylesheet -->
    <link rel="stylesheet" href="    {{ asset('contents/website/assets/css') }}/bootstrap.css">
    <!-- include the site stylesheet -->
    <link rel="stylesheet" href="    {{ asset('contents/website/assets/css') }}/animate.css">
    <!-- include the site stylesheet -->
    <link rel="stylesheet" href="    {{ asset('contents/website/assets/css') }}/icon-fonts.css">
    <!-- include the site stylesheet -->
...
<body>
    ...
    <div id="wrapper">
        ...
        {{-- <div id="pre-loader" class="loader-container">
            <div class="loader">
                <img src="    {{ asset('contents/website/assets/images') }}/svg/rings.svg" alt="loader">
            </div>
        </div> --}}
        <!-- W1 start here -->
        <div class="w1">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="mt-logo"><a href="#"><img
                                            src="    {{ asset('contents/website/assets/images') }}/mt-logo.png"
                                            alt="schon"></a></div>
                                ...
                                <ul class="mt-icon-list">
                                    ...
                                    <li class="drop">
                                        <a href="#" class="icon-heart cart-opener"><span
                                                style="margin-bottom: -3px;" class="num">3</span></a>
                                        <!-- mt drop start here -->
                                        <div class="mt-drop">
                                                ...
                                                <div class="mt-side-widget">
                                                    ...
                                                    <div class="cart-row">
                                                        <a href="#" class="img"><img
                                                                src="    {{ asset('contents/website/assets/images') }}/products/img36.jpg"
                                                    ...
                                                    <div class="cart-row">
                                                        <a href="#" class="img"><img
                                                                src="    {{ asset('contents/website/assets/images') }}/products/img37.jpg"
                                                                alt="image" class="img-responsive"></a>
                                                        <div class="mt-h">
                                                            <span class="mt-h-title"><a href="#">Marvelous Modern
                                                                    3 Seater</a></span>
                                                    ...
                                                    <div class="cart-row">
                                                        <a href="#" class="img"><img
                                                                src="    {{ asset('contents/website/assets/images') }}/products/img38.jpg"
                                                                alt="image" class="img-responsive"></a>
                                                        <div class="mt-h">
                                                            <span class="mt-h-title"><a href="#">Marvelous Modern
                                                                    3 Seater</a></span>
                                                ...
                                                <div class="mt-side-widget">
                                                    ...
                                                    <div class="cart-row">
                                                        <a href="#" class="img"><img
                                                                ...
                                                                alt="image" class="img-responsive"></a>
                                                        <div class="mt-h">
                                                            <span class="mt-h-title"><a href="#">Marvelous
                                                                    Modern 3 Seater</a></span>
                                                            <span class="price"><i class="fa fa-eur"
                                                                    aria-hidden="true"></i> 599,00</span>
                                ...
                                <nav id="nav">
                                    <ul>
                                        ...
                                        <li>
                                            <a class="drop-link" href="product-grid-view.html">PRODUCTS <i
                                                    class="fa fa-angle-down hidden-lg hidden-md"
                                                    aria-hidden="true"></i></a>
                                                    <span class="mt-mdropover"></span>
                                            {{-- <div class="s-drop">
                                                    ...
                                                    <div class="mt-f-box">
                                                            ...
                                                            <div class="sub-dropcont">
                                                                ...
                                                                <div class="sub-drop">
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="loginpage.html">Login Page</a>
                                                                        </li>
                                                        ...
                                                        <div class="mt-col-3 promo">
                                                            <div class="mt-promobox">
                                                                <a href="#"><img
                                                                        src="    {{ asset('contents/website/assets/images') }}/banner-drop.jpg"
                                        ...
                                        <li>
                                            <a  href="{{ route('website.contact') }}">Contact<i
                                                    class="fa fa-angle-down hidden-lg hidden-md"
                                                    aria-hidden="true"></i></a>
                                            {{-- <div class="s-drop">
                                                <ul>
                                        ...
                                        <div class="news-column">
                                            ...
                                            <div class="txt-box">
                                                <p>Laboris nisi ut <a href="#">#schön</a> aliquip econse-
                                                    <br>quat. <a href="#">https://t.co/vreNJ9nEDt</a>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="news-column">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 text-right">
                                <div class="bank-card">
                                    <img src="    {{ asset('contents/website/assets/images') }}/bank-card.png"
                                        alt="bank-card">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="slider">
                                ...
                                <div class="product-slider">
                                    <div class="slide">
                                        <img src="    {{ asset('contents/website/assets/images') }}/img03.jpg"
                                ...
                                <ul class="list-unstyled slick-slider pagg-slider">
                                    <li><img src="    {{ asset('contents/website/assets/images') }}/img03.jpg"
            ...
            <section class="mt-newsletter-popup">
                ...
                <div class="holder">
                    ...
                    <div class="img-holder">
                        <img src="    {{ asset('contents/website/assets/images') }}/img02.png"
    ...
    <!-- include jQuery -->
    <script src="{{ asset('contents/website/assets/js') }}/jquery.main.js"></script>
</body>
{{ asset('contents/website/assets/js') }}/
